...
class NLPEngineer:
    def __init__(self):
        ...
        self.languages    = {"Arabic": "Native", "English": "Professional Working Proficiency"}
        self.currently_at = "DEPI — Agentic AI & GenAI System Developer Trainee"
        self.stack        = ["LangGraph", "Hugging Face", "Qdrant", "FastAPI", "PyTorch", "MLflow"]
...
**🔭 Right now, I'm...**
- Engineering **AraCheck** — a tiered LLM → RAG → Web-Search escalation pipeline that only reaches for more evidence when it's genuinely unsure
- Building **clinical speech intelligence** — ASR + zero-shot NER pipelines that transcribe *and* understand medical audio
...
**🌱 What drives me**
- Native Arabic speaker building **Arabic-first NLP** — because most of the field forgets my language exists
- Obsessed with **calibrated confidence** over confident-sounding nonsense
- Believer in evidence-grounded AI: every answer should be able to point at *why*
...
<details>
<summary><b>📈 Skill depth (click to expand)</b></summary>
<br>

| Area | Proficiency |
|---|---|
| NLP & Text Understanding | `█████████░` 90% |
| LLMs & Agentic AI (RAG, LangGraph) | `████████░░` 85% |
| Deep Learning (RNN/Transformer from scratch) | `████████░░` 80% |
| Speech & Multimodal (ASR, VLM, OCR) | `███████░░░` 75% |
| Classical ML (scikit-learn) | `████████░░` 80% |
| Web Dev (PHP, MySQL, JS) | `██████░░░░` 65% |
...
<img src="https://streak-stats.demolab.com/?user=gehad-abdulaziz&theme=tokyonight&hide_border=true&ring=38BDF8&fire=A78BFA"/>
...
<i>"Every answer should be able to point at why."</i>

<br><br>

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0EA5E9,50:9333EA,100:6B46C1&height=120&section=footer" width="100%"/>
